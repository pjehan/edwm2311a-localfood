 ...
 */
final class Version20240327092500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE place ADD city_id INT NOT NULL, ADD address VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE place DROP city_id, DROP address');
    }
}
